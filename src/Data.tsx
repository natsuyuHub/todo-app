...
const Data: React.FC = memo(() => {
  ...
  const createAPI = (uuid: string, text: string) => {
    const requestOptions = {
      ...
      body: JSON.stringify({ uuid, todovalue: text })
    }
  ...
  return (
    <div className='home'>
      ...
      {editValue && editValue.text && (
        <EditForm editValue={editValue.text} errorText={errorText} handleSubmit={handleSubmit} setInput={setInput} />
      )}
